...
import { TranslationPresenceValidator } from './wiki-bot/validation/translation-presence-validator';
...
async function bootstrap(): Promise<void> {
    ...
    const translationPresenceValidator = new TranslationPresenceValidator();
